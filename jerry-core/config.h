 ...
 */
#define CONFIG_MEM_HEAP_MAX_LIMIT 16384
#define HEAP_LIMIT_SIZE 196608
/**
 * Desired limit of heap usage
 */
#define CONFIG_MEM_HEAP_DESIRED_LIMIT (JERRY_MIN (CONFIG_MEM_HEAP_AREA_SIZE / 16, CONFIG_MEM_HEAP_MAX_LIMIT))
